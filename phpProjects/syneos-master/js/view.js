...
(function(){
  ...
  class RoomView {
    ...
    load(){
      var oSelf = this;
      $.get('controllers/roomView.php?action=fetchRoomView',function(res){
  ...
  class Room {
    ...
    showRoom(){
      $(this.container).html($('#app').html($('#tpl-intro').html()));
    }
  ...
  ES.RoomList = RoomView; //== Push this class to namespace ES
